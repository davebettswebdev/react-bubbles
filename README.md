...
- [X] Explain what a token is used for.
      ...
      A token is used to authenticate a user and dictate the access they have on a website. 

- [X] What steps can you take in your web apps to keep your data secure?

      Make sure the app is checking for the token and use private routing. 
  
- [X] Describe how web servers work.

      A server is a computer connected to a network/internet that stores data and allows other computers connected to it to access that information.
